...
<div class="container"><!--Container -->
    ...
    <h6>Por favor, envíe los detalles de su reserva a PayPal para confirmar su pago parcial del 10%</h6>    
			<hr>
    ...
    <table>
                ...
                <tr class="alert alert-info">
                	<td><strong>Pago de paypal</strong></td>
                    <td><div align="right"><i class="icon-info-sign"></i>PAGAR AHORA 10%:</div></td>
                    <td width="100px"><div align="right">S/. <?php echo $pre;?>.00</div></td>
                
                </tr>
                <tr>
                	<td></td>
                    <td><div align="right">Numero de Habitacion:</div></td>
   ...
   ?>
    ...
    <?php }?> </div></td>
                ...
                <tr class="alert alert-success">
					<td><strong>Detalles del Huesped</strong></td>
